...
def main():
    ...
    ap.add_argument("--traces", type=str, default=None, help="Path to traces JSON (Jaeger-like)")
    ap.add_argument("--logs", type=str, default=None, help="Path to logs JSONL or text")
    ap.add_argument("--metrics", type=str, default=None, help="Path to metrics CSV (time,service,metric,value)")
    ap.add_argument("--incident-id", type=str, default="demo_incident")
    ap.add_argument("--start", type=str, default=None, help="ISO start time filter (inclusive)")
    ap.add_argument("--end", type=str, default=None, help="ISO end time filter (inclusive)")
